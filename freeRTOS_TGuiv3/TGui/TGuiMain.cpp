...
void TGuiRun()
{
	...
	TRadioButton radio1(TRect(50, 100, 150, 30),TImage("1:/tgui_pic/radio_nor.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选1", &user);
	TRadioButton radio2(TRect(50, 140, 150, 30),TImage("1:/tgui_pic/radio_empty.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选2", &user);
	TRadioButton radio3(TRect(50, 180, 150, 30),TImage("1:/tgui_pic/radio_nor.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选3", &user);
	...
	TPushButton btn2(50,220,TImage("1:/tgui_pic/button.png"),TImage("1:/tgui_pic/button_sel.png"),"按钮", &user);
	...
	TCheckBox chck(TRect(50,20,150,30),TImage("1:/tgui_pic/check1_nor.png"),TImage("1:/tgui_pic/check1_sel.png"),"复选1", &user);
	TCheckBox chck1(TRect(50,60,150,30),TImage("1:/tgui_pic/check2_nor.png"),TImage("1:/tgui_pic/check2_sel.png"),"复选2", &user);
	...
	TDialog dialog2(350, 150, 250, 200, "dialog", &user);
 	TPushButton btn1(410, 200, TImage("1:/tgui_pic/button.png"),TImage("1:/tgui_pic/button_sel.png"),"按钮",&dialog2);
