	...
	:TWindow(filename,app,n,obj)
{
	...
	radio1 = new TRadioButton(TRect(50, 100, 150, 30),TImage("1:/tgui_pic/radio_nor.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选1", this);
	radio2 = new TRadioButton(TRect(50, 140, 150, 30),TImage("1:/tgui_pic/radio_empty.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选2", this);
	radio3 = new TRadioButton(TRect(50, 180, 150, 30),TImage("1:/tgui_pic/radio_nor.png"),TImage("1:/tgui_pic/radio_sel.png"),"单选3", this);
	...
	img = new TImageBox(620,0,TImage("1:/tgui_pic/imac.png"),NULL, this);
	
	//TPushButton* btn = new TPushButton(50,230,150,65, "button", this);
	btn = new TPushButton(50,220,TImage("1:/tgui_pic/button.png"),TImage("1:/tgui_pic/button_sel.png"),"按钮", this);
	swtch = new TSwitch(50,270,TImage("1:/tgui_pic/switch_off.png"),TImage("1:/tgui_pic/switch_on.png"),NULL, this);
	
	//TCheckBox* chck = new TCheckBox(50,50,150,30,"check1", this);
	chck = new TCheckBox(TRect(50,20,150,30),TImage("1:/tgui_pic/check1_nor.png"),TImage("1:/tgui_pic/check1_sel.png"),"复选1", this);
	chck1 = new TCheckBox(TRect(50,60,150,30),TImage("1:/tgui_pic/check2_nor.png"),TImage("1:/tgui_pic/check2_sel.png"),"复选2", this);
	...
	icon = new TIconButton(300,30,TImage("1:/tgui_pic/profile.png"),TImage("1:/tgui_pic/play.png"),"通讯录",this);
