...
/**
  ...
  *     @arg DBGMCU_SLEEP: Keep debugger TConnection during SLEEP mode              
  *     @arg DBGMCU_STOP: Keep debugger TConnection during STOP mode               
  *     @arg DBGMCU_STANDBY: Keep debugger TConnection during STANDBY mode        
