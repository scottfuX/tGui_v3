...
void LCD_Clear(uint32_t Color)
{
  ...
  Alpha_Value = (0xFF000000 & CurrentTextColor)>>24;
  Red_Value = (0x00FF0000 & CurrentTextColor)>>16 ;
  Green_Value = (0x0000FF00 & CurrentTextColor)>>8;
  Blue_Value = 0x000000FF & CurrentTextColor;
...
{  
  ...
  LTDC_colorkeying_InitStruct.LTDC_ColorKeyBlue = 0x000000FF & RGBValue;
  LTDC_colorkeying_InitStruct.LTDC_ColorKeyGreen = (0x0000FF00 & RGBValue);
  LTDC_colorkeying_InitStruct.LTDC_ColorKeyRed = (0x00FF0000 & RGBValue) ;  
...
{ 
...
#else /*这样直接描点效率估计高点吧*/
 {
	  /*RGB888*/
	  uint32_t  Xaddress =0;
    Xaddress =  CurrentFrameBuffer + 4*(LCD_PIXEL_WIDTH*y + x);
	  *(__IO uint16_t*)(Xaddress+1)= (0x0000FFFF & CurrentTextColor);        //GB
  	*(__IO uint8_t*)( Xaddress+3)= (0x00FF0000 & CurrentTextColor) >> 16;   //R
  }
#endif
}
